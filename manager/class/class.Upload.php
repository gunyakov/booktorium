...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            'script_url' => "http://lbm2.t-library.net/uploadFiles.php",
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|djvu|pdf|rar|zip|rtf|doc|txt)$/i',
            //'accept_file_types' => '/.+$/i',
            ...
            'max_number_of_files' => MAX_UPLOAD_COUNT,
    ...
    protected function get_full_url() {
        return USER_DOWNLOAD_LINK;
    }

    protected function get_user_id() {
    	$objSession = $GLOBALS['objSession'];
		return $objSession->getUserPath();
    }
